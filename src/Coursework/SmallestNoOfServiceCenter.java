package Coursework;//2
//b) You are given an array of binary trees that represent different cities where a certain corporation has its branch
//        office and the organization wishes to provide service by constructing a service center. Building service centers at
//        any node, i.e., a city can give service to it's directly connected cities where it can provide service to its parents,
...
//        Output: 2
//        Explanation: construction of two service centers denoted by black mark will be enough to provide service to all
//        cities.
